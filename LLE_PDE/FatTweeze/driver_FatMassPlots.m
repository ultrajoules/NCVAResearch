...
print -djpeg95 -r300 FatQInC.jpg 
%the following might not work unless you have the appropriate converters:
!convert FatQIn.jpg -trim FatQIn.jpg
!jpeg2ps FatQIn.jpg > FatQIn.jpg.ps
...
orient portrait
% for surfaces it is better to save a raster pic otherwise files get huge:
print -djpeg95 -r300 FatQOutC.jpg 
%the following might not work unless you have the appropriate converters:
!convert FatQOut.jpg -trim FatQOut.jpg
!jpeg2ps FatQOut.jpg > FatQOut.jpg.ps
...
orient portrait
% for surfaces it is better to save a raster pic otherwise files get huge:
print -djpeg95 -r300 FatQOut.jpg 
%the following might not work unless you have the appropriate converters:
!convert FatQOut.jpg -trim FatQOut.jpg
!jpeg2ps FatQOut.jpg > FatQOut.jpg.ps