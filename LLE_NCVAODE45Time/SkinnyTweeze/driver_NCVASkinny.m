...
NCVASurfPlot = ['NCVASkinnyMassPlot.mat'];
tt = [t0:dt:Tend];
...
for i = 1:length(cmax);
    ct = cmax(i);
    NCVASaveName = ['NCVASkinny_xf',num2str(ct),'.mat'];
...
%                  drawnow;pause(0.1);
    ...
    save(NCVASaveName, 'saveuVA', 'MassIn','MassOut','Potential','uPt','ct','betatau','paramsNCVA','MassTotal','VAN','saveN')
end
