function [allU, uPt, Mass_In, Mass_Out, potential] = cNLS1D(stopsave, saveframes, maxTiterations,N,dt,xi0,...
    uini,ohdxx,eta,V,oos,allx,allt,damping_step,dx,E,dE,ddE,ct,betat,uSS)
...
t = 0;
taut = tau0; %10*sin(2*pi*speedC*t);
savenumber = 0;
...
for j = 1:maxTiterations;
    t = t+dt;
    taut = tau0 + (ct/2)*(tanh(betat*(t-tauStar))./tanh(betat*tauStar) + 1); %10*sin(2*pi*speedC*t);
    V = E(xi0, taut, sigma_X, h);
    V1 = dE(xi0, taut, sigma_X, h);
    V2 = ddE(xi0, taut, sigma_X, h);
